...
public class MenuAppuntamento extends javax.swing.JPanel implements ActionListener {
   ...
   /*     this.modificaButtonServizi1.setAreaServizi(pannello);
    ...
    private void initComponents() {
        ...
        aggiungiButtonAppuntamento1 = new it.seerp.Gui.Menu.AggiungiButtonAppuntamento();
        eiminaButtonAppuntamento1 = new it.seerp.Gui.Menu.EiminaButtonAppuntamento();
        modificaButtonAppuntamento1 = new it.seerp.Gui.Menu.ModificaButtonAppuntamento();
    ...
    private it.seerp.Gui.Menu.AggiungiButtonAppuntamento aggiungiButtonAppuntamento1;
    private it.seerp.Gui.Menu.EiminaButtonAppuntamento eiminaButtonAppuntamento1;
    private it.seerp.Gui.Menu.ModificaButtonAppuntamento modificaButtonAppuntamento1;
