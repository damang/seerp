...
public interface GestioneUtenti<E extends Utente, U extends BeanGuiUtente> {
     ...
     */
    public ArrayList<E> visualizzaTabella() throws SQLException;
     ...
     */
    public ArrayList<U> elenca(ArrayList<U> listGui) throws SQLException, ValidatorException;
     ...
     */
    public ArrayList<U> ricerca(ArrayList<U> list) throws SQLException, ValidatorException;
     ...
     */
    public void elimina(int id, U user)throws SQLException, ValidatorException;
     ...
     */
    public void eliminazioneLogica(U user)throws SQLException, ValidatorException;
     ...
     */
    public void inserisci(U user)throws SQLException, ValidatorException;
     ...
     * nel caso in cui i dati inseriti sono errati
     */
    public U modifica(int id, U user)throws SQLException, ValidatorException;
     ...
     * nel caso in cui i dati inseriti sono errati
     */
    public U visualizzaDati(int user, U beanGui)throws SQLException, ValidatorException;
}
